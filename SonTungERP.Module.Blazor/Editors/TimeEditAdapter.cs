...
{
    public class TimeEditAdapter : ComponentAdapterBase
    {
        public TimeEditAdapter(TimeInputModel componentModel)
        {
            ComponentModel = componentModel ?? throw new ArgumentNullException(nameof(componentModel));
            ComponentModel.ValueChanged += ComponentModel_ValueChanged;
        }
        public TimeInputModel ComponentModel { get; }
        ...
        {
            ComponentModel.Value = (DateTime?)value;
        }
