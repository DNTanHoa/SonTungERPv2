...
namespace SonTungERP.Blazor.Server {
    public partial class SonTungERPBlazorApplication : BlazorApplication {
        public SonTungERPBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void SonTungERPBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
